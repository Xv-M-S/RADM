...
import numpy as np
from test_constracts_adjust_v2 import DynamicBarrierOptimizer

# (此处假定 DynamicBarrierOptimizer 类已定义，直接调用)
# 如果你是分段运行，请确保上一段代码中的 Class 已运行
...
def run_complex_scenario_1():
    ...
    opt = DynamicBarrierOptimizer(init_boxes, constraints, fidelity_alpha=2.0)
...
def run_complex_scenario_2():
    ...
    opt = DynamicBarrierOptimizer(init_boxes, constraints, fidelity_alpha=0.5)
    final_boxes = opt.optimize(steps=400)
